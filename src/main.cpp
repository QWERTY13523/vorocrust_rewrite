...
int main()
{
    ...
    generator.generate_spheres("./data/spheres/Sphere_6000_55_block_density_kappa.csv", spheres);
    generator.read_obj_faces("./data/obj/Ours_6000_block_Remesh_density_kappa.obj",face_flat, num_faces1);
    ...
    //generator.ensure_seed_pair_adjacency(seeds);
